define(["jquery-widget-init", "handlebars.helpers",
    ...
    $.widget("ud.ud_notetaking", {
        ...
        setPositionHandler: function(obj){
            this._positionHandler=obj;
        },
        _create: function(){
            ...
            $("input[type=radio]", $(".sidebar-container")).bind('change', function (e) {
                this.scrollNotesToBottom();
            }.bind(this));
        },
        _initHandlebarsTemplates: function() {
        	this.noteTemplate = Handlebars.compile($("#noteTemplate").html());
        },
