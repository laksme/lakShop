...
bouncex.website = {"cae":false,"ei":1,"cookie_name":"bounceClientVisit858","base_host":"bounceexchange.com","vars":{"logged_In":{"polling":"none","persist":"no","val":"jQuery('a[href*=\"logout\"]').length>0?true:false","default":"false"},"ever_logged_in":{"polling":"none","persist":"permanent","val":"bouncex.vars.logged_in || bouncex.vars.ever_logged_in","default":"false"},"language":{"polling":"none","persist":"no","val":"navigator.language","default":""},"em_conv_bool":{"polling":"none","persist":"permanent","val":"null","default":"0"}},"acts":[],"pi":1000,"ct":"bind_to_domain","tcjs":"","cjs":"if ($.grep(document.cookie.split(';'),function(n){return n.indexOf('lastLoggedInDate')>=0}).length>0 && bouncex.vars.em_conv_bool == 0 && parseInt(UD.me.id)>4000000 ) {\n\t bouncex.report_conversion({\n             order_id: UD.me.id,\n             \/\/email: UD.me.email,\n             goal: 'signup'\n         });\n         bouncex.setv('em_conv_bool', '1');\n\t bouncex.setBounceCookie();\n } else if ($.grep(document.cookie.split(';'),function(n){return n.indexOf('lastLoggedInDate')>=0}).length>0 && window.top.location.href.indexOf('courses') != 22 && bouncex.vars.em_conv_bool == 0) {\n\tbouncex.setv('em_conv_bool', '1');\n\tbouncex.setBounceCookie();\n }\n","PMI":500,"PDI":1000,"PMR":30,"force_https":false,"waypoints":false,"gai":"","ots":0,"sd":0,"aco":{"first_party_limit":"3500"},"id":858,"campaign_id":0,"tpc":0,"uwc":1,"domain":"Udemy.com","bau":"api.bounceexchange.com","is_preview":false,"mas":2,"map":1,"burls":[],"ibx":{"cjs":"","miw":"0","mibcx":0,"te":0,"tjs":"","cart_rep":{"get":"","set":""}}};
window.console || (window.console = {log: function () { return {} }});


if(bouncex.website.cae){
	var _veroq = _veroq || [];
}
var bcx_init = function(){
	...
	bouncex.referrer = encodeURIComponent(document.referrer);
	...
	if(!bouncex.visit_cookie){
		...
		bouncex.visit_cookie.r = bouncex.referrer.substring(0,1000).replace(/\+/g,'%2B');
		bouncex.visit_cookie.lp = bouncex.calling_url.substring(0,1000).replace(/\+/g,'%2B');
	...
	bouncex.wndsize = function(){
		...
		if(bouncex.website.cae){
		if (typeof(opensoft)==='undefined' || !opensoft.Davinci) {
			try {
				(function() {var ve = document.createElement('script'); ve.type = 'text/javascript'; ve.async = true; ve.src = '//bounceexchange.com/assets/global/plugins/abandon.js'; var s = document.getElementsByTagName('head')[0].appendChild(ve, s);})();
				
				_veroq.push(['init',{api_key:'1cf1f3d73e168daf4e73112bec91cb5a71143381',development_mode: false}]);
			} catch(err) {
				bouncex.log(err);
			}
		}
	...
	if(bouncex.website.is_preview){
		...
		if(areCookiesEnabled()){
			...
			if(bouncex.website.vars || bouncex.website.acts){
				bcxReady=true;	
			}
...
if(bouncex.website.ct=='multi_cookie'){ 
	function MultiCookie(k){this.disable_first_party=!1;this.first_party_limit=999999;this.domain=window.location.host;this.best=function(a,b){return b.length>a.length?b:a};this.parse_json=function(a){return JSON.parse(a)};this.stringify_json=function(a){return JSON.stringify(a)};this.set_qs=function(a,b,c){return a=-1==a.indexOf("&"+b+"=")?a+("&"+b+"="+c):a.replace(new RegExp("&"+b+"=[^&]*"),"&"+b+"="+c)};for(var l in k)this[l]=k[l];var g=window.localStorage,h=window.globalStorage;this.set=function(a,
...
(function(){
	bouncex.init_lightbox = function(){
		...
		addStyle(bouncex.bu+'/assets/bounce/bounce.css?v39');
	}
	...
	function activation_funcs(){var e=[];e["manual"]=function(e,t,n){};e["control"]=function(e,t,n){show_ad("control",n)};e["inter"]=function(e,t,n){if(bouncex.cookie.vpv>=e){show_ad("inter",n)}};e["bounce"]=function(e,t,n){bxBind("html,body","mouseout.bouncex_show_"+n,function(e){process_mouse_out(e,n)});if(bouncex.browser.msie||bouncex.browser.safari&&bouncex.browser.safari<=50){bxBind("html,body","mousemove.bouncex_show_"+n,function(e){process_mouse_move(e,n)})}init_helpers(n)};e["timer"]=function(e,t,n){bouncex_events["timeout_timer"+n]=setTimeout(function(){show_ad("timer",n)},parseInt(t)*1e3)};e["back"]=function(e,t,n){var r=false;if(e=="landing_page"){if(bouncex.state.iol){r=true}}else{r=true}if(r){activate_hash(n)}};e["pers"]=function(e,t,n){var r=false;bouncex.campaigns[n].is_pers=true;if(e=="landing_page"&&bouncex.state.iol){r=true}else if(e!="landing_page"){r=true}if(r){show_ad("pers",n)}};e["worm"]=function(e,t,n){noteCookieAdShown(n,true);teleport("_self",t)};e["inactivity"]=function(e,t,n){bouncex.inactivity_events="mousemove.bouncex keydown.bouncex DOMMouseScroll.bouncex mousewheel.bouncex mousedown.bouncex touchstart.bouncex touchmove.bouncex";bxBind(document.body,bouncex.inactivity_events,function(){clearTimeout(bouncex.inactivity_timeout);bouncex.inactivity_timeout=bouncex_events["inactivity"+n]=setInactivityTimeout(n,t)});bouncex.inactivity_timeout=setInactivityTimeout(n,t)};e["scroll"]=function(e,t,n){bouncex.oldSy=100;bxBind(window,"scroll.bouncex_"+n,function(){var e=jQuery(this);var r=bouncex.wndsize();var i=e.scrollTop();i=i?i:document.body.scrollTop;var s=(i+r.height)/jQuery(document).height()*100;var o=parseInt(s)+parseInt(t);if(o>100&&s>bouncex.oldSy&&!bouncex.campaigns[n].ad_shown){show_ad("scroll",n);if(!can_show_ad(n,true)){jQuery(window).unbind("scroll.bouncex_"+n)}}bouncex.oldSy=s})};e["mclick"]=function(e,t,n){if(e=="left"&&bouncex.campaigns[n].overlay=="teleport"&&bouncex.campaigns[n].overlay_teleport_type!=="_self"){var r=function(){show_ad("mclick",n)};addEvent(window.document,"click",r)}else{var r=function(t){var i=t.keyCode||t.which||t.button;if(t.button&&t.button==2)i=3;if(e=="left"&&i==1||e=="any"){show_ad("mclick",n)}if(e=="right"&&i==3||e=="any"){show_ad("mclick",n)}if(!can_show_ad(n,true)){removeEvent(window.document,"mousedown",r)}};addEvent(window.document,"mousedown",r)}};return e}
		...
		bouncex.report_conversion = function(obj){report_conversion(obj);};
						...
						bouncex.ibx={wsid:bouncex.website.id,_event_store:[],_item_store:[],vid:bouncex.cookie.vid,uid:null,bxl:null,crt:null,token:null,mode:1,cvar:{},_init:function(){this.uid=this._get("user");this.mode=this._get("mode");this._renew_token();this.bxl=this._get("bx_lookup");this.crt=this._get("cart");this._cart("set");this._clkthrough();this._log("initialized");this._log("mode: "+this.mode+" | "+"token: "+this.token)},user:function(e,t){if(!this._validate(e)){this._log("invalid email");return}this.set("user",1);var n=this._cart("get");if(n){t=t||{};t.__cart=n}this._push("user",{key:e,val:t})},track:function(e,t,n,r){if(!e||!t){this._log("type and key must be set");return}if(this["_"+e+"_store"]){this["_"+e+"_store"].push({key:JSON.stringify(n)})}if(!r)r="";this._push(e,{key:t,val:n,segment:r})},conv_params:function(){var e=this._auto_add({ibx_token:this._get("token"),ibx_mode:this._get("mode"),ibx_clicks:this._get("clickstr")});if(e.ibx_clicks){this._cookies.create("__ibxc0",e.ibx_clicks);this._cookies.destroy("__ibxc")}this._log("conv_params: "+(e.ibx_clicks?e.ibx_clicks:"[none]"));return this._qs(e)},set:function(e,t){switch(e){case"token":this.token=t;bouncex.cookie.ibxt=encodeURIComponent(t);setBounceCookie();this._cookies.destroy("__ibxt");break;case"user":this.uid=t;this._cookies.create("__ibxu",t);break;case"mode":if(t==0||t==1){this.mode=t;this._cookies.create("__ibxm",t)}break;case"bx_lookup":this.bxl=t;this._cookies.create("__ibxl",t);break;case"cart":this.crt=t;this._cookies.create("__ibxcr",t,0.5);break}return t},dump:function(e){this._log(e+" = "+this._get(e))},_get:function(e){var t;switch(e){case"events":t=this._event_store;break;case"items":t=this._item_store;break;case"token":if(bouncex.cookie.ibxt){t=decodeURIComponent(bouncex.cookie.ibxt)}else{t=this._cookies.read("__ibxt")}break;case"user":t=parseInt(this._cookies.read("__ibxu"));if(isNaN(t))t=0;break;case"mode":t=this._cookies.read("__ibxm")==="0"?0:1;break;case"clickstr":t=this._cookies.read("__ibxc");break;case"clicks":t=(t=this._cookies.read("__ibxc"))?t.split(","):[];break;case"bx_lookup":t=parseInt(this._cookies.read("__ibxl"));if(isNaN(t))t=0;break;case"cart":t=parseInt(this._cookies.read("__ibxcr"));if(isNaN(t))t=0;break;default:t="invalid"}return t},_push:function(e,t){var n,r="type="+e+"&wsid="+this.wsid+"&gcr="+bouncex.cookie.gcr+"&vid="+this.vid+"&mode="+(isNaN(this.mode)?1:parseInt(this.mode));try{mode=parseInt(this.mode)}catch(i){mode=1}r+="&uid=";this._renew_token();r+="&token="+encodeURIComponent(this.token);t.val=JSON.stringify(this._auto_add(t.val||{}));r=r+"&"+this._qs(t);n=typeof t.key!="undefined"?": "+t.key:"";this._log(e.toUpperCase()+n+" // "+r);jQuery('<img src="'+bouncex.au+'/ibx/ping?'+r+'"/>')},_auto_add:function(e){e=e||{};e.__url=location.href;e.__referrer=document.referrer;return e},_renew_token:function(){var e=this._get("token");if(!e||e==""){e=btoa(this.vid)}this.set("token",e);return e},_bx_lookup:function(){if(this.bxl)return;if(bouncex.cookie.es&&bouncex.cookie.campaigns&&!bouncex.ibx.uid){var e=bouncex.cookie.campaigns;var t=null;for(var n in e){if(e.hasOwnProperty(n)&&e[n].ls&&e[n].lavid){t=e[n].lavid}}if(t){var r={vid:t,__src:"bx_lookup"};var i=this._cart("get");if(i){r.__cart=i}this._push("bx_lookup",{key:t,val:r})}}this.set("bx_lookup",1)},_cart:function(action){var cart=false;switch(action){case"get":try{cart=eval(bouncex.website.ibx.cart_rep.get)}catch(e){cart=false;this._log(e)}break;case"set":if(this.crt||location.href.indexOf("ibx_cart")==-1)return false;cart=this._getparam("ibx_cart");if(cart){eval(bouncex.website.ibx.cart_rep.set);this.set("cart",1)}cart=this.crt;break}return cart},_clkthrough:function(){var e=this._getparam("ibx_source"),t;if(e){try{t=this._get("clickstr");if(!t)t=e;else if(t.indexOf(e)!=-1){this._log("click-through: "+e+" (DUPLICATE)");return}else t+=","+e;this._cookies.create("__ibxc",t);this._log("click-through: "+e)}catch(n){this._log(n)}}},_log:function(e){if(this.mode==0)bouncex.log("ibx: "+e)},_validate:function(e){var t=/^(([^<>()[\]\\.,;:\s@\"]+(\.[^<>()[\]\\.,;:\s@\"]+)*)|(\".+\"))@((\[[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}\])|(([a-zA-Z\-0-9]+\.)+[a-zA-Z]{2,}))$/;return t.test(e)},_quick_validate:function(e){return e==null?false:e.indexOf(".")>2&&e.indexOf("@")>0},_qs:function(e){var t=[],n="";for(var r in e){if(!e.hasOwnProperty(r))continue;t.push(r+"="+encodeURIComponent(e[r]))}return t.join("&")},_cookies:{domain:window.bouncex.cookie_domain,create:function(e,t,n){if(!n)n=365;var r=new Date;r.setTime(r.getTime()+n*24*60*60*1e3);var i="; expires="+r.toGMTString(),s=this.domain?"domain=."+this.domain+";":"";document.cookie=e+"="+t+i+"; path=/;"+s},read:function(e){var t=e+"=",n=document.cookie.split(";");for(var r=0;r<n.length;r++){var i=n[r];while(i.charAt(0)==" ")i=i.substring(1,i.length);if(i.indexOf(t)==0)return i.substring(t.length,i.length)}return null},destroy:function(e){this.create(e,"",-1)}},_getparam:function(e){e=e.replace(/[\[]/,"\\[").replace(/[\]]/,"\\]");var t="[\\?&]"+e+"=([^&#]*)";var n=new RegExp(t);var r=n.exec(window.location.href);if(r==null)return"";else return decodeURIComponent(r[1])}};bouncex.ibx._init();
		init_ibx_tracking();
